...
const host = "0.0.0.0"; //todas interfaces de rede possam acessar a nossa aplicacao
const porta = 3000; // aplicacao identificada pelo numero 3000
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="/listajogadores">Lista de Jogadores</a></li>
                            </ul>
                        </li>
...
//Diferente do metodo get, que exigia do usuario a passagem de parametros por meio da URL
//iremos utilizar nessa aula o metodo POST

//poder enviar dados de um jogador usando um formulario HTML
// a aplicacao devera entregar ou oferecer tal formulario HTML
app.get("/jogador", (requisicao, resposta) => {
    //retornar uma pagina contendo formulario HTML
    resposta.write(`
        <!doctype html>
        <html lang="pt-br">
            <head>
                <meta charset="utf-8">
                <title>Formulario de cadastro Jogador</title>
                <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-sRIl4kxILFvY47J16cr9ZwB07vP4J8+LH7qKQnuqkuIAvNWLzeN8tE5YBujZqJLB" crossorigin="anonymous">
            </head>
            <body>
                <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/js/bootstrap.bundle.min.js" integrity="sha384-FKyoEForCGlyvwx9Hj09JcYn3nv7wiPVlz7YYwJrWVcXK/BmnVDxM+D2scQbITxI" crossorigin="anonymous"></script>
                <div class="container mt-5">
                        ...
                        <div class="row">
                            <label class="colFormLabel" for="apelido">Apelido</label>
                            <input type="text" class="form-control" id="apelido" name="apelido">
                        </div>
                        <div class="row">
                            <label class="colFormLabel" for="nivel">Nível do jogador</label>
...
//esperar por dados de um formulario HTML
app.post("/jogador", (requisicao, resposta) => {
    //deve adicionar um novo jogador, criando um novo estado da aplicacao
    //usando o metodo POST o formulario HTML envia os seus dados no corpo da requisicao
    const nome = requisicao.body.nome;
    const apelido = requisicao.body.apelido;
    const nivel = requisicao.body.nivel;
    
    //impedir que um jogadir 'vazio' seja cadastrado
    if(!nome || !apelido || !nivel){
        //mostrar novamente o formulario para o usuario corrigir os dados exibindo mensagens de validacao
        let html = `
        <!doctype html>
        <html lang="pt-br">
            <head>
                ...
                <div class="container mt-5">
                        ...
                        if(!nivel){
                            ...
                            <div class="alert alert-danger" role="alert">
                                Por favor informe o nível do jogador
                            </div>
                            `; 
                        }
                    ...
                    <main class="form-signin w-100 m-auto">
                        <form> 
                            ...
                            <div class="form-floating"> <input type="email" class="form-control" id="floatingInput"
                                    placeholder="name@example.com"> <label for="floatingInput">Email</label> </div>
                            <div class="form-floating"> <input type="password" class="form-control" id="floatingPassword"
                                    placeholder="Password"> <label for="floatingPassword">Senha</label> </div>
                            <div class="form-check text-start my-3"> <input class="form-check-input" type="checkbox" value="remember-me"
                                    ...
                                    Lembre-me
                                </label> </div> <button class="btn btn-primary w-100 py-2" type="submit">Login</button>
                        </form>
                    </main>
                    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/js/bootstrap.bundle.min.js" integrity="sha384-FKyoEForCGlyvwx9Hj09JcYn3nv7wiPVlz7YYwJrWVcXK/BmnVDxM+D2scQbITxI" crossorigin="anonymous"></script>
                </div>    
